...
env.CUDA_VISIBLE_DEVICES                       = '2'       # Unspecified (default) = Use all available GPUs. List of ints = CUDA device numbers to use.
...
desc += '-preset-v2-1gpu'; num_gpus = 1; gpu_numbver = 0; sched.minibatch_base = 4; sched.minibatch_dict = {4: 128, 8: 128, 16: 128, 32: 64, 64: 32, 128: 16, 256: 8, 512: 4}; sched.G_lrate_dict = {1024: 0.0015}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 12000
